...
public interface QuarkusScimAsyncApi extends com.langfuse.api.scim.async.ScimApi {
    ...
    CompletionStage<ScimUser> scimCreateUser(
     ...
     */
    @Override
    default CompletionStage<ScimUser> scimCreateUser(APIScimCreateUserRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<Object> scimDeleteUser(
     ...
     */
    @Override
    default CompletionStage<Object> scimDeleteUser(APIScimDeleteUserRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    CompletionStage<ResourceTypesResponse> scimGetResourceTypes();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    CompletionStage<SchemasResponse> scimGetSchemas();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    CompletionStage<ServiceProviderConfig> scimGetServiceProviderConfig();
    ...
    @Path("/api/public/scim/Users/{userId}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<ScimUser> scimGetUser(
            @PathParam("userId") String userId);
     ...
     */
    @Override
    default CompletionStage<ScimUser> scimGetUser(APIScimGetUserRequest apiRequest) {
    ...
    @Path("/api/public/scim/Users")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<ScimUsersListResponse> scimListUsers(
     ...
     */
    @Override
    default CompletionStage<ScimUsersListResponse> scimListUsers(APIScimListUsersRequest apiRequest) {
