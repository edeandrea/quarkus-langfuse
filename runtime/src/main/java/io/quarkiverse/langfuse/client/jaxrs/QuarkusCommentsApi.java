 ...
 */
public interface QuarkusCommentsApi extends com.langfuse.api.comments.CommentsApi {
    ...
    CreateCommentResponse commentsCreate(
     ...
     */
    @Override
    default CreateCommentResponse commentsCreate(APICommentsCreateRequest apiRequest) {
    ...
    @Path("/api/public/comments")
    @Produces(MediaType.APPLICATION_JSON)
    GetCommentsResponse commentsGet(
     ...
     */
    @Override
    default GetCommentsResponse commentsGet(APICommentsGetRequest apiRequest) {
     ...
     */
    @Override
    default Comment commentsGetById(APICommentsGetByIdRequest apiRequest) {
