...
public interface QuarkusAnnotationQueuesAsyncApi extends com.langfuse.api.annotationQueues.async.AnnotationQueuesApi {
    ...
    CompletionStage<AnnotationQueue> annotationQueuesCreateQueue(
     ...
     */
    @Override
    default CompletionStage<AnnotationQueue> annotationQueuesCreateQueue(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<CreateAnnotationQueueAssignmentResponse> annotationQueuesCreateQueueAssignment(
     ...
     */
    @Override
    default CompletionStage<CreateAnnotationQueueAssignmentResponse> annotationQueuesCreateQueueAssignment(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<AnnotationQueueItem> annotationQueuesCreateQueueItem(
            @PathParam("queueId") String queueId,
     ...
     */
    @Override
    default CompletionStage<AnnotationQueueItem> annotationQueuesCreateQueueItem(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<DeleteAnnotationQueueAssignmentResponse> annotationQueuesDeleteQueueAssignment(
            @PathParam("queueId") String queueId,
            AnnotationQueueAssignmentRequest annotationQueueAssignmentRequest);
     ...
     */
    @Override
    default CompletionStage<DeleteAnnotationQueueAssignmentResponse> annotationQueuesDeleteQueueAssignment(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<DeleteAnnotationQueueItemResponse> annotationQueuesDeleteQueueItem(
            @PathParam("queueId") String queueId,
     ...
     */
    @Override
    default CompletionStage<DeleteAnnotationQueueItemResponse> annotationQueuesDeleteQueueItem(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<AnnotationQueue> annotationQueuesGetQueue(
            @PathParam("queueId") String queueId);
     ...
     */
    @Override
    default CompletionStage<AnnotationQueue> annotationQueuesGetQueue(APIAnnotationQueuesGetQueueRequest apiRequest) {
    ...
    @Path("/api/public/annotation-queues/{queueId}/items/{itemId}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<AnnotationQueueItem> annotationQueuesGetQueueItem(
            @PathParam("queueId") String queueId,
            @PathParam("itemId") String itemId);
     ...
     */
    @Override
    default CompletionStage<AnnotationQueueItem> annotationQueuesGetQueueItem(
    ...
    @Path("/api/public/annotation-queues/{queueId}/items")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<PaginatedAnnotationQueueItems> annotationQueuesListQueueItems(
            @PathParam("queueId") String queueId,
     ...
     */
    @Override
    default CompletionStage<PaginatedAnnotationQueueItems> annotationQueuesListQueueItems(
    ...
    @Path("/api/public/annotation-queues")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<PaginatedAnnotationQueues> annotationQueuesListQueues(
            @QueryParam("page") Integer page,
            @QueryParam("limit") Integer limit);
     ...
     */
    @Override
    default CompletionStage<PaginatedAnnotationQueues> annotationQueuesListQueues(
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<AnnotationQueueItem> annotationQueuesUpdateQueueItem(
            @PathParam("queueId") String queueId,
            @PathParam("itemId") String itemId,
     ...
     */
    @Override
    default CompletionStage<AnnotationQueueItem> annotationQueuesUpdateQueueItem(
