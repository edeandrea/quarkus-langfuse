...
/**
 * Langfuse Observations Async API
 */
public interface QuarkusObservationsAsyncApi extends com.langfuse.api.observations.async.ObservationsApi {
    ...
    CompletionStage<ObservationsV2Response> observationsGetMany(
