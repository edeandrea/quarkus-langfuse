...
/**
 * Langfuse ScoreConfigs API
 */
public interface QuarkusScoreConfigsApi extends com.langfuse.api.scoreConfigs.ScoreConfigsApi {
    ...
    ScoreConfig scoreConfigsCreate(
     ...
     */
    @Override
    default ScoreConfig scoreConfigsCreate(APIScoreConfigsCreateRequest apiRequest) {
     ...
     */
    @Override
    default ScoreConfigs scoreConfigsGet(APIScoreConfigsGetRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    ScoreConfig scoreConfigsGetById(
     ...
     */
    @Override
    default ScoreConfig scoreConfigsGetById(APIScoreConfigsGetByIdRequest apiRequest) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    ScoreConfig scoreConfigsUpdate(
            @PathParam("configId") String configId,
     ...
     */
    @Override
    default ScoreConfig scoreConfigsUpdate(APIScoreConfigsUpdateRequest apiRequest) {
