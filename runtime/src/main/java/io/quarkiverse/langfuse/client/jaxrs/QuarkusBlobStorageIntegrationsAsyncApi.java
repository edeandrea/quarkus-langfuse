...
/**
 * Langfuse Blob Storage Integrations Async API
 */
public interface QuarkusBlobStorageIntegrationsAsyncApi
    ...
    CompletionStage<BlobStorageIntegrationDeletionResponse> blobStorageIntegrationsDeleteBlobStorageIntegration(
     ...
     */
    @Override
    default CompletionStage<BlobStorageIntegrationDeletionResponse> blobStorageIntegrationsDeleteBlobStorageIntegration(
    ...
    @Path("/api/public/integrations/blob-storage/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<BlobStorageIntegrationStatusResponse> blobStorageIntegrationsGetBlobStorageIntegrationStatus(
            @PathParam("id") String id);
     ...
     */
    @Override
    default CompletionStage<BlobStorageIntegrationStatusResponse> blobStorageIntegrationsGetBlobStorageIntegrationStatus(
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Override
    CompletionStage<BlobStorageIntegrationsResponse> blobStorageIntegrationsGetBlobStorageIntegrations();
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<BlobStorageIntegrationResponse> blobStorageIntegrationsUpsertBlobStorageIntegration(
     ...
     */
    @Override
    default CompletionStage<BlobStorageIntegrationResponse> blobStorageIntegrationsUpsertBlobStorageIntegration(
