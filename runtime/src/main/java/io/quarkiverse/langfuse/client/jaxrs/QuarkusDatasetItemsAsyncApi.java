...
/**
 * Langfuse DatasetItems Async API
 */
public interface QuarkusDatasetItemsAsyncApi extends com.langfuse.api.datasetItems.async.DatasetItemsApi {
    ...
    CompletionStage<DatasetItem> datasetItemsCreate(
     ...
     */
    @Override
    default CompletionStage<DatasetItem> datasetItemsCreate(APIDatasetItemsCreateRequest apiRequest) {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<DeleteDatasetItemResponse> datasetItemsDelete(
     ...
     */
    @Override
    default CompletionStage<DeleteDatasetItemResponse> datasetItemsDelete(APIDatasetItemsDeleteRequest apiRequest) {
    ...
    @Path("/api/public/dataset-items/{id}")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<DatasetItem> datasetItemsGet(
            @PathParam("id") String id);
     ...
     */
    @Override
    default CompletionStage<DatasetItem> datasetItemsGet(APIDatasetItemsGetRequest apiRequest) {
    ...
    @Path("/api/public/dataset-items")
    @Produces(MediaType.APPLICATION_JSON)
    CompletionStage<PaginatedDatasetItems> datasetItemsList(
     ...
     */
    @Override
    default CompletionStage<PaginatedDatasetItems> datasetItemsList(APIDatasetItemsListRequest apiRequest) {
