...
class LangfuseNoOtelBeansTest {
    ...
    @Test
    void langfuseSpanProcessorNotLoadable() {
        assertThat(isClassLoadable("io.quarkiverse.langfuse.runtime.otel.LangfuseSpanProcessor"))
                .as("LangfuseSpanProcessor should not be loadable when OTel is absent")
                .isFalse();
    }
